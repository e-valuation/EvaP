...
from evap.results.tools import (calculate_average_course_distribution, calculate_average_distribution, collect_results,
                                ...
                                unipolarized_distribution, can_user_see_textanswer)
    ...
    def test_correct_contributors_and_delegate_count_are_shown_in_textanswer_visibility_info(self):
        ...
        for user in UserProfile.objects.all():
            ...
            for i in range(len(textanswers)):
                if can_user_see_textanswer(user, represented_users, textanswers[i], 'full'):
                    if can_user_see_textanswer(user, [user], textanswers[i], 'full'):
