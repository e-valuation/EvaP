...
class TestCourses(TestCase):
    ...
    def test_has_enough_questionnaires(self):
        ...
        self.assertFalse(course.has_main_questionnaire)
        self.assertFalse(course.has_all_questionnaires)
        ...
        self.assertTrue(course.has_main_questionnaire)
        self.assertFalse(course.has_all_questionnaires)

        responsible_contribution.questionnaires.add(questionnaire)
        self.assertTrue(course.has_main_questionnaire)
        self.assertTrue(course.has_all_questionnaires)
