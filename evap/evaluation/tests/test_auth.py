...
class LoginTests(WebTest):
    ...
    def setUpTestData(cls):
        ...
        mommy.make(Contribution, course=course, contributor=cls.external_user, can_edit=True, responsible=True, comment_visibility=Contribution.GENERAL_COMMENTS)
        mommy.make(Contribution, course=course, contributor=cls.inactive_external_user, can_edit=True, responsible=False, comment_visibility=Contribution.GENERAL_COMMENTS)
