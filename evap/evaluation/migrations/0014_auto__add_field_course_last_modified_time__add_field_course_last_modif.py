...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.last_modified_time'
        db.add_column('evaluation_course', 'last_modified_time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 2, 17, 15, 28, 0, 616000), blank=True), keep_default=False)

        # Adding field 'Course.last_modified_user'
        db.add_column('evaluation_course', 'last_modified_user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.last_modified_time'
        db.delete_column('evaluation_course', 'last_modified_time')

        # Deleting field 'Course.last_modified_user'
        db.delete_column('evaluation_course', 'last_modified_user_id')
    ...
    models = {
        ...
        'evaluation.course': {
            ...
            'last_modified_user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['auth.User']"}),
