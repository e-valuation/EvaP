...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'QuestionGroup.obsolete'
        db.add_column('evaluation_questiongroup', 'obsolete', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'QuestionGroup.obsolete'
        db.delete_column('evaluation_questiongroup', 'obsolete')
