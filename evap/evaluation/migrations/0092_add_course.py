    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_modified_time",
                    models.DateTimeField(default=django.utils.timezone.now, verbose_name="Last modified"),
                ),
                (
                    "degrees",
                    models.ManyToManyField(related_name="courses", to="evaluation.Degree", verbose_name="degrees"),
                ),
                (
                    "last_modified_user",
                    models.ForeignKey(
                        ...
                        related_name="courses_last_modified+",
