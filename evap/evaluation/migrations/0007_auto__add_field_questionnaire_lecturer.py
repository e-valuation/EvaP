...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Questionnaire.lecturer'
        db.add_column('evaluation_questionnaire', 'lecturer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Questionnaire.lecturer'
        db.delete_column('evaluation_questionnaire', 'lecturer_id')
