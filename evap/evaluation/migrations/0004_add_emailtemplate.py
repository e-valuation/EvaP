...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        if not db.dry_run:
            ...
            orm['contenttypes.contenttype'].objects.filter(app_label='fsr', model='emailtemplate').update(app_label='evaluation')


    def backwards(self, orm):
        db.rename_table('evaluation_emailtemplate', 'fsr_emailtemplate') 
        if not db.dry_run:
            # For permissions to work properly after migrating
            orm['contenttypes.contenttype'].objects.filter(app_label='evaluation', model='emailtemplate').update(app_label='fsr')
