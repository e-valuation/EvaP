...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_unique(u'evaluation_assignment', ['course_id', 'contributor_id'])
        db.rename_table(u'evaluation_assignment', u'evaluation_contribution')
        db.create_unique(u'evaluation_contribution', ['course_id', 'contributor_id'])
        db.rename_table(db.shorten_name(u'evaluation_assignment_questionnaires'), db.shorten_name(u'evaluation_contribution_questionnaires'))
        db.rename_column(db.shorten_name(u'evaluation_contribution_questionnaires'), 'assignment_id', 'contribution_id')
        db.rename_column(u'evaluation_textanswer', 'assignment_id', 'contribution_id')
        db.rename_column(u'evaluation_gradeanswer', 'assignment_id', 'contribution_id')


    def backwards(self, orm):
        db.delete_unique(u'evaluation_contribution', ['course_id', 'contributor_id'])
        db.rename_table(u'evaluation_contribution', u'evaluation_assignment')
        db.create_unique(u'evaluation_assignment', ['course_id', 'contributor_id'])
        db.rename_table(db.shorten_name(u'evaluation_contribution_questionnaires'), db.shorten_name(u'evaluation_assignment_questionnaires'))
        db.rename_column(db.shorten_name(u'evaluation_contribution_questionnaires'), 'contribution_id', 'assignment_id')
        db.rename_column(u'evaluation_textanswer', 'contribution_id', 'assignment_id')
        db.rename_column(u'evaluation_gradeanswer', 'contribution_id', 'assignment_id')
