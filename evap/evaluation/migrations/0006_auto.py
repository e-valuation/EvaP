...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field primary_lecturers on 'Course'
        db.create_table('evaluation_course_primary_lecturers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('course', models.ForeignKey(orm['evaluation.course'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('evaluation_course_primary_lecturers', ['course_id', 'user_id'])

        # Adding M2M table for field secondary_lecturers on 'Course'
        db.create_table('evaluation_course_secondary_lecturers', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('course', models.ForeignKey(orm['evaluation.course'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('evaluation_course_secondary_lecturers', ['course_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field primary_lecturers on 'Course'
        db.delete_table('evaluation_course_primary_lecturers')

        # Removing M2M table for field secondary_lecturers on 'Course'
        db.delete_table('evaluation_course_secondary_lecturers')
