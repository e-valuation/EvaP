...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.study'
        db.add_column('evaluation_course', 'study', self.gf('django.db.models.fields.CharField')(default=u'Bachelor', max_length=100), keep_default=False)

        # Adding field 'Questionnaire.teaser_de'
        db.add_column('evaluation_questionnaire', 'teaser_de', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Questionnaire.teaser_en'
        db.add_column('evaluation_questionnaire', 'teaser_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.study'
        db.delete_column('evaluation_course', 'study')

        # Deleting field 'Questionnaire.teaser_de'
        db.delete_column('evaluation_questionnaire', 'teaser_de')

        # Deleting field 'Questionnaire.teaser_en'
        db.delete_column('evaluation_questionnaire', 'teaser_en')
