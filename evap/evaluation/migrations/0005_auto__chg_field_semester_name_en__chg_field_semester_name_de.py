...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('evaluation_semester', 'name_en', self.gf('django.db.models.fields.CharField')(unique=True, max_length=140))

        # Changing field 'Semester.name_de'
        db.alter_column('evaluation_semester', 'name_de', self.gf('django.db.models.fields.CharField')(unique=True, max_length=140))


    def backwards(self, orm):
        
        # Changing field 'Semester.name_en'
        db.alter_column('evaluation_semester', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True))

        # Changing field 'Semester.name_de'
        db.alter_column('evaluation_semester', 'name_de', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True))
    ...
    models = {
        ...
        'evaluation.semester': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name_de': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '140'}),
            'name_en': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '140'})
        },
