...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Course', fields ['name_en', 'semester', 'study']
        db.create_unique('evaluation_course', ['name_en', 'semester_id', 'study'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Course', fields ['name_en', 'semester', 'study']
        db.delete_unique('evaluation_course', ['name_en', 'semester_id', 'study'])
    ...
    models = {
        ...
        'evaluation.course': {
            'Meta': {'ordering': "('semester', 'name_de')", 'unique_together': "(('semester', 'study', 'name_de'), ('semester', 'study', 'name_en'))", 'object_name': 'Course'},
