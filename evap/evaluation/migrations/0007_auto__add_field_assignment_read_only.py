...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('evaluation_assignment', 'read_only', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Assignment.read_only'
        db.delete_column('evaluation_assignment', 'read_only')
