...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'evaluation_userprofile', 'title', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

        # Changing field 'Semester.name_en'
        db.alter_column(u'evaluation_semester', 'name_en', self.gf('django.db.models.fields.CharField')(unique=True, max_length=1024))

        # Changing field 'Semester.name_de'
        db.alter_column(u'evaluation_semester', 'name_de', self.gf('django.db.models.fields.CharField')(unique=True, max_length=1024))

        # Changing field 'Course.kind'
        db.alter_column(u'evaluation_course', 'kind', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'Course.degree'
        db.alter_column(u'evaluation_course', 'degree', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'Course.name_de'
        db.alter_column(u'evaluation_course', 'name_de', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'Course.name_en'
        db.alter_column(u'evaluation_course', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'Questionnaire.public_name_de'
        db.alter_column(u'evaluation_questionnaire', 'public_name_de', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'Questionnaire.public_name_en'
        db.alter_column(u'evaluation_questionnaire', 'public_name_en', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'Questionnaire.name_de'
        db.alter_column(u'evaluation_questionnaire', 'name_de', self.gf('django.db.models.fields.CharField')(unique=True, max_length=1024))

        # Changing field 'Questionnaire.name_en'
        db.alter_column(u'evaluation_questionnaire', 'name_en', self.gf('django.db.models.fields.CharField')(unique=True, max_length=1024))

    def backwards(self, orm):

        # Changing field 'UserProfile.title'
        db.alter_column(u'evaluation_userprofile', 'title', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))

        # Changing field 'Semester.name_en'
        db.alter_column(u'evaluation_semester', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True))

        # Changing field 'Semester.name_de'
        db.alter_column(u'evaluation_semester', 'name_de', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True))

        # Changing field 'Course.kind'
        db.alter_column(u'evaluation_course', 'kind', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Course.degree'
        db.alter_column(u'evaluation_course', 'degree', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Course.name_de'
        db.alter_column(u'evaluation_course', 'name_de', self.gf('django.db.models.fields.CharField')(max_length=140))

        # Changing field 'Course.name_en'
        db.alter_column(u'evaluation_course', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=140))

        # Changing field 'Questionnaire.public_name_de'
        db.alter_column(u'evaluation_questionnaire', 'public_name_de', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Questionnaire.public_name_en'
        db.alter_column(u'evaluation_questionnaire', 'public_name_en', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Questionnaire.name_de'
        db.alter_column(u'evaluation_questionnaire', 'name_de', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True))

        # Changing field 'Questionnaire.name_en'
        db.alter_column(u'evaluation_questionnaire', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=100, unique=True))
