...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'evaluation_course', 'study', 'degree')

        db.rename_table(db.shorten_name(u'evaluation_userprofile_proxies'), db.shorten_name(u'evaluation_userprofile_delegates'))


    def backwards(self, orm):
        db.rename_column(u'evaluation_course', 'degree', 'study')

        db.rename_table(db.shorten_name(u'evaluation_userprofile_delegates'), db.shorten_name(u'evaluation_userprofile_proxies'))
