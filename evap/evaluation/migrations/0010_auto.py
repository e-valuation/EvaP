...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field primary_lecturer_questions on 'Course'
        db.create_table('evaluation_course_primary_lecturer_questions', (
        ...
        db.create_unique('evaluation_course_primary_lecturer_questions', ['course_id', 'questiongroup_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field primary_lecturer_questions on 'Course'
        db.delete_table('evaluation_course_primary_lecturer_questions')
