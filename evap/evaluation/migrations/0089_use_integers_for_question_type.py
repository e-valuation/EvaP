...
CONVERSION = {"T": 0, "L": 1, "G": 2, "P": 3, "N": 4, "H": 5}
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RemoveField(model_name="question", name="type"),
        migrations.RenameField(model_name="question", old_name="int_type", new_name="type"),
    ]
