...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Assignment.read_only'
        db.delete_column(u'evaluation_assignment', 'read_only')

        # Adding field 'Assignment.can_edit'
        db.add_column(u'evaluation_assignment', 'can_edit',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Assignment.read_only'
        db.add_column(u'evaluation_assignment', 'read_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Assignment.can_edit'
        db.delete_column(u'evaluation_assignment', 'can_edit')
