...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Course.participant_count'
        db.add_column('evaluation_course', 'participant_count', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Adding field 'Course.voter_count'
        db.add_column('evaluation_course', 'voter_count', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Course.participant_count'
        db.delete_column('evaluation_course', 'participant_count')

        # Deleting field 'Course.voter_count'
        db.delete_column('evaluation_course', 'voter_count')
