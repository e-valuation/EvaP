...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('evaluation_question', '_order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Question._order'
        db.delete_column('evaluation_question', '_order')
