...
<a href="/profile">You can assign your own delegates on your profile page.</a>
<br>            
Evaluations from lecturers who set you as a delegate are marked with a label below.
<br>
<em>More details: <a href="/faq#faq-15-q">FAQ/Delegates</a></em>
<br>
<br>
<b>States of the evaluations</b>
<br>
...
<br>
<em>More details: <a href="/faq#faq-18-q">FAQ/States</a></em>
<br>
<br>
...
<br>
<em>Mehr Infos: <a href="/faq#faq-18-q">FAQ/Zustände</a></em>
<br>
<br>
<b>Evaluierungs-Ergebnisse</b>
<br>
...
<br>
<em>More details: <a href="/faq#faq-21-q">FAQ/Anonymity</a></em>
<br>
<br>
<b>References to other answers</b>
<br>
...
<br>
<em>More details: <a href="/faq#faq-24-q">FAQ/Reference</a></em>
<br>
<br>
<b>Evaluation Results</b>
<br>
...
<br>
<em>Mehr Infos: <a href="/faq#faq-21-q">FAQ/Anonymität</a></em>
<br>
<br>
<b>Verweise auf andere Antworten</b>
<br>
...
<br>
<em>Mehr Infos: <a href="/faq#faq-24-q">FAQ/Verweise</a></em>
<br>
<br>
<b>Evaluierungs-Ergebnisse</b>
<br>
...
<em>Mehr Infos: <a href="/faq#faq-3-s">FAQ/Ergebnisse</a></em>""",
    ...
    for title_en, title_de, content_en, content_de, linked_page in infotexts:
        #if not Infotext.objects.filter(linked_page=linked_page).exists():
        Infotext.objects.create(title_en=title_en, title_de=title_de, content_en=content_en, content_de=content_de, linked_page=linked_page)

def remove_infotexts(apps, _schema_editor):
    Infotext = apps.get_model("evaluation", "Infotext")
    Infotext.objects.all().delete()


class Migration(migrations.Migration):
    dependencies = [
        ('evaluation', '0132_add_infotext_model'),
    ]

    operations = [
        migrations.RunPython(create_infotexts, reverse_code=remove_infotexts),
    ]
