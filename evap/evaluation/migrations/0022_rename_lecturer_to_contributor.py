...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_unique(u'evaluation_assignment', ['course_id', 'lecturer_id'])
        db.rename_column(u'evaluation_assignment', 'lecturer_id', 'contributor_id')
        db.create_unique(u'evaluation_assignment', ['course_id', 'contributor_id'])
        db.rename_column(u'evaluation_questionnaire', 'is_for_persons', 'is_for_contributors')


    def backwards(self, orm):
        db.delete_unique(u'evaluation_assignment', ['course_id', 'contributor_id'])
        db.rename_column(u'evaluation_assignment', 'contributor_id', 'lecturer_id')
        db.create_unique(u'evaluation_assignment', ['course_id', 'lecturer_id'])
        db.rename_column(u'evaluation_questionnaire', 'is_for_contributors', 'is_for_persons')
    ...
    models = {
        ...
        u'evaluation.assignment': {
            'Meta': {'unique_together': "(('course', 'contributor'),)", 'object_name': 'Assignment'},
