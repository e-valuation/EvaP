...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_column('evaluation_semester', 'visible')

        # Deleting field 'Semester.created_at'
        db.delete_column('evaluation_semester', 'created_at')
    ...
    models = {
        ...
        'evaluation.semester': {
            'Meta': {'ordering': "('created_at',)", 'object_name': 'Semester'},
