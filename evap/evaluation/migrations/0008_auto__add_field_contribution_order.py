...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contribution.order'
        db.add_column(u'evaluation_contribution', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contribution.order'
        db.delete_column(u'evaluation_contribution', 'order')
