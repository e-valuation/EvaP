...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Questionnaire.public_name_de'
        db.add_column('evaluation_questionnaire', 'public_name_de', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

        # Adding field 'Questionnaire.public_name_en'
        db.add_column('evaluation_questionnaire', 'public_name_en', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Questionnaire.public_name_de'
        db.delete_column('evaluation_questionnaire', 'public_name_de')

        # Deleting field 'Questionnaire.public_name_en'
        db.delete_column('evaluation_questionnaire', 'public_name_en')
