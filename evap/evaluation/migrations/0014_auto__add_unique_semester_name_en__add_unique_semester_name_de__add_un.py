...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Semester', fields ['name_en']
        db.create_unique('evaluation_semester', ['name_en'])

        # Adding unique constraint on 'Semester', fields ['name_de']
        db.create_unique('evaluation_semester', ['name_de'])

        # Adding unique constraint on 'Course', fields ['semester', 'name_de']
        db.create_unique('evaluation_course', ['semester_id', 'name_de'])

        # Adding unique constraint on 'Course', fields ['semester', 'name_en']
        db.create_unique('evaluation_course', ['semester_id', 'name_en'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Course', fields ['semester', 'name_en']
        db.delete_unique('evaluation_course', ['semester_id', 'name_en'])

        # Removing unique constraint on 'Course', fields ['semester', 'name_de']
        db.delete_unique('evaluation_course', ['semester_id', 'name_de'])

        # Removing unique constraint on 'Semester', fields ['name_de']
        db.delete_unique('evaluation_semester', ['name_de'])

        # Removing unique constraint on 'Semester', fields ['name_en']
        db.delete_unique('evaluation_semester', ['name_en'])
