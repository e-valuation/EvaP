...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'QuestionGroup.description_de'
        db.add_column('evaluation_questiongroup', 'description_de', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'QuestionGroup.description_en'
        db.add_column('evaluation_questiongroup', 'description_en', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'QuestionGroup.description_de'
        db.delete_column('evaluation_questiongroup', 'description_de')

        # Deleting field 'QuestionGroup.description_en'
        db.delete_column('evaluation_questiongroup', 'description_en')
