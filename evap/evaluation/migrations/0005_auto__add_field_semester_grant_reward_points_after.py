...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Semester.grant_reward_points_after'
        db.add_column(u'evaluation_semester', 'grant_reward_points_after',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2099, 12, 31, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Semester.grant_reward_points_after'
        db.delete_column(u'evaluation_semester', 'grant_reward_points_after')
    ...
    models = {
        ...
        u'evaluation.contribution': {
            ...
            'contributor': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'contributions'", 'null': 'True', 'to': u"orm['auth.User']"}),
        ...
        u'evaluation.semester': {
            ...
            'grant_reward_points_after': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name_de': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '1024'}),
            'name_en': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '1024'})
        },
