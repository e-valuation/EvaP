...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.fsr'
        db.add_column('evaluation_userprofile', 'fsr', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.fsr'
        db.delete_column('evaluation_userprofile', 'fsr')
