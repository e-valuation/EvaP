...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.logon_key_valid_until'
        db.add_column('evaluation_userprofile', 'logon_key_valid_until', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.logon_key_valid_until'
        db.delete_column('evaluation_userprofile', 'logon_key_valid_until')
