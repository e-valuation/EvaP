...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TextAnswer.answer'
        db.delete_column('evaluation_textanswer', 'answer')

        # Adding field 'TextAnswer.censored_answer'
        db.add_column('evaluation_textanswer', 'censored_answer', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'TextAnswer.original_answer'
        db.add_column('evaluation_textanswer', 'original_answer', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'TextAnswer.checked'
        db.add_column('evaluation_textanswer', 'checked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'TextAnswer.hidden'
        db.add_column('evaluation_textanswer', 'hidden', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'TextAnswer.answer'
        raise RuntimeError("Cannot reverse this migration. 'TextAnswer.answer' and its values cannot be restored.")

        # Deleting field 'TextAnswer.censored_answer'
        db.delete_column('evaluation_textanswer', 'censored_answer')

        # Deleting field 'TextAnswer.original_answer'
        db.delete_column('evaluation_textanswer', 'original_answer')

        # Deleting field 'TextAnswer.checked'
        db.delete_column('evaluation_textanswer', 'checked')

        # Deleting field 'TextAnswer.hidden'
        db.delete_column('evaluation_textanswer', 'hidden')
    ...
    models = {
        ...
        'evaluation.textanswer': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lecturer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['auth.User']"}),
            'original_answer': ('django.db.models.fields.TextField', [], {}),
            'question': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['evaluation.Question']"})
        }
    }
