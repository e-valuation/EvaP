...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Assignment', fields ['lecturer', 'course']
        db.create_unique('evaluation_assignment', ['lecturer_id', 'course_id'])

        # Adding field 'UserProfile.is_lecturer'
        db.add_column('evaluation_userprofile', 'is_lecturer', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'Assignment', fields ['lecturer', 'course']
        db.delete_unique('evaluation_assignment', ['lecturer_id', 'course_id'])

        # Deleting field 'UserProfile.is_lecturer'
        db.delete_column('evaluation_userprofile', 'is_lecturer')
