...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.logon_key'
        db.add_column('evaluation_userprofile', 'logon_key', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.logon_key'
        db.delete_column('evaluation_userprofile', 'logon_key')
    ...
    models = {
        ...
        'evaluation.userprofile': {
            ...
            'proxies': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'proxied_users'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
