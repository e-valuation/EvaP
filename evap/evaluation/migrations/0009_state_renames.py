...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm['evaluation.Course'].objects.filter(state='pendingLecturerApproval').update(state='prepared')
        orm['evaluation.Course'].objects.filter(state='pendingFsrApproval').update(state='lecturerApproved')
        orm['evaluation.Course'].objects.filter(state='pendingForReview').update(state='evaluated')
        orm['evaluation.Course'].objects.filter(state='pendingPublishing').update(state='reviewed')


    def backwards(self, orm):
        "Write your backwards methods here."
        orm['evaluation.Course'].objects.filter(state='prepared').update(state='pendingLecturerApproval')
        orm['evaluation.Course'].objects.filter(state='lecturerApproved').update(state='pendingFsrApproval')
        orm['evaluation.Course'].objects.filter(state='evaluated').update(state='pendingForReview')
        orm['evaluation.Course'].objects.filter(state='reviewed').update(state='pendingPublishing')
