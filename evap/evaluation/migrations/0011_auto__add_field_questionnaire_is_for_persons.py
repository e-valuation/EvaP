...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Questionnaire.is_for_persons'
        db.add_column('evaluation_questionnaire', 'is_for_persons', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Questionnaire.is_for_persons'
        db.delete_column('evaluation_questionnaire', 'is_for_persons')
