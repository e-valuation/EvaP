...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.is_external'
        db.add_column(u'evaluation_userprofile', 'is_external',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.is_external'
        db.delete_column(u'evaluation_userprofile', 'is_external')
