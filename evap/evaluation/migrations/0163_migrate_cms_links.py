...
def move_to_evaluation_app(apps, _schema_editor):
    ...
    for cms_evaluation_link in EvaluationLink.objects.all():
        cms_evaluation_link.evaluation.cms_id = cms_evaluation_link.cms_id
        cms_evaluation_link.delete()

    for cms_course_link in CourseLink.objects.all():
        cms_course_link.course.cms_id = cms_course_link.cms_id
        cms_course_link.delete()
