...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Course.visible'
        db.delete_column('evaluation_course', 'visible')

        # Adding field 'Course.state'
        db.add_column('evaluation_course', 'state', self.gf('django_fsm.db.fields.fsmfield.FSMField')(default='new', max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Course.visible'
        db.add_column('evaluation_course', 'visible', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Course.state'
        db.delete_column('evaluation_course', 'state')
