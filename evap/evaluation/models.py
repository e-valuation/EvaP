...
class Semester(models.Model):
    ...
    name_de = models.CharField(max_length=140, unique=True, verbose_name=_(u"name (german)"))
    name_en = models.CharField(max_length=140, unique=True, verbose_name=_(u"name (english)"))
