...
class Questionnaire(models.Model):
    ...
    @inject_choices_constraint("questionnaire", locals())
    class Meta:
...
class Evaluation(LoggedModel):
    ...
    @inject_choices_constraint("evaluation", locals())
    class Meta:
        unique_together = [
            ["course", "name_de"],
            ["course", "name_en"],
...
class Contribution(LoggedModel):
    ...
    @inject_choices_constraint("contribution", locals())
    class Meta:
...
class Question(models.Model):
    ...
    @inject_choices_constraint("question", locals())
    class Meta:
        ordering = ["order"]
...
class TextAnswer(Answer):
    ...
    @inject_choices_constraint("textanswer", locals())
    class Meta:
...
class Infotext(models.Model):
    ...
    @inject_choices_constraint("infotext", locals())
    class Meta:
...
class UserProfile(EvapBaseUser, PermissionsMixin):
    ...
    @inject_choices_constraint("userprofile", locals())
    class Meta:
