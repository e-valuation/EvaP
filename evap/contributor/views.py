...
from evap.evaluation.auth import editor_required, editor_or_delegate_required, editor_or_delegate_or_contributor_required
...
@editor_or_delegate_or_contributor_required
def index(request):
    user = request.user
