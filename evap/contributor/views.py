...
def course_view(request, course_id):
	...
	if (course.is_user_editor_or_delegate(user) and course.state in ['approved']):
		messages.info(request, _('You cannot edit this course because it already has been approved.'))
