...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SemesterActivation'
        db.create_table(u'rewards_semesteractivation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('semester', self.gf('django.db.models.fields.related.ForeignKey')(related_name='rewards_active', unique=True, to=orm['evaluation.Semester'])),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'rewards', ['SemesterActivation'])


    def backwards(self, orm):
        # Deleting model 'SemesterActivation'
        db.delete_table(u'rewards_semesteractivation')
    ...
    models = {
        ...
        u'rewards.semesteractivation': {
            'Meta': {'object_name': 'SemesterActivation'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'semester': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'rewards_active'", 'unique': 'True', 'to': u"orm['evaluation.Semester']"})
        }
    }
