...
urlpatterns = [
    ...
    path(
        "semester/<int:semester_id>/participation_export",
        views.semester_participation_export,
        name="semester_participation_export",
    ),
    path(
        "semester/<int:semester_id>/vote_timestamps_export", views.vote_timestamps_export, name="vote_timestamps_export"
    ),
    path(
        "semester/<int:semester_id>/assign", views.semester_questionnaire_assign, name="semester_questionnaire_assign"
    ),
    path(
        "semester/<int:semester_id>/preparation_reminder",
        views.semester_preparation_reminder,
        name="semester_preparation_reminder",
    ),
    path("semester/<int:semester_id>/grade_reminder", views.semester_grade_reminder, name="semester_grade_reminder"),
    path(
        "semester/<int:semester_id>/responsible/<int:responsible_id>/send_reminder",
        views.send_reminder,
        name="send_reminder",
    ),
    path(
        "semester/archive_participations", views.semester_archive_participations, name="semester_archive_participations"
    ),
    path("semester/archive_results", views.semester_archive_results, name="semester_archive_results"),
    path(
        "semester/delete_grade_documents", views.semester_delete_grade_documents, name="semester_delete_grade_documents"
    ),
    path(
        "semester/<int:semester_id>/evaluation/create",
        views.evaluation_create_for_semester,
        name="evaluation_create_for_semester",
    ),
    path(
        "course/<int:course_id>/evaluation/create",
        views.evaluation_create_for_course,
        name="evaluation_create_for_course",
    ),
    ...
    path(
        "evaluation/<int:evaluation_id>/person_management",
        views.evaluation_person_management,
        name="evaluation_person_management",
    ),
    path(
        "evaluation/<int:evaluation_id>/login_key_export",
        views.evaluation_login_key_export,
    ...
    path(
        "semester/<int:semester_id>/singleresult/create",
        views.single_result_create_for_semester,
        name="single_result_create_for_semester",
    ),
    path(
        "course/<int:course_id>/singleresult/create",
        views.single_result_create_for_course,
        name="single_result_create_for_course",
    ),
    path("evaluation/<int:evaluation_id>/textanswers", views.evaluation_textanswers, name="evaluation_textanswers"),
    path(
        "semester/<int:semester_id>/flagged_textanswers",
        views.semester_flagged_textanswers,
        name="semester_flagged_textanswers",
    ),
    path("textanswer/<uuid:textanswer_id>/edit", views.evaluation_textanswer_edit, name="evaluation_textanswer_edit"),
    path(
        "textanswers/update_publish",
        views.evaluation_textanswers_update_publish,
        name="evaluation_textanswers_update_publish",
    ),
    path(
        "textanswers/update_flag", views.evaluation_textanswers_update_flag, name="evaluation_textanswers_update_flag"
    ),
    ...
    path(
        "questionnaire/<int:questionnaire_id>/new_version",
        views.questionnaire_new_version,
        name="questionnaire_new_version",
    ),
    ...
    path(
        "course_types/<int:main_type_id>/merge/<int:other_type_id>", views.course_type_merge, name="course_type_merge"
    ),
    ...
    path(
        "export_contributor_results/<int:contributor_id>",
        views.export_contributor_results_view,
        name="export_contributor_results",
    ),
