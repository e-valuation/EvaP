...
class TestPersonImporter(TestCase):
    ...
    def test_import_existing_contributor(self):
        ...
        success_messages, warnings, errors = PersonImporter.process_source_evaluation('contributor', self.evaluation1, test_run=True, source_evaluation=self.evaluation1)
        ...
        success_messages, warnings, errors = PersonImporter.process_source_evaluation('contributor', self.evaluation1, test_run=False, source_evaluation=self.evaluation1)
    ...
    def test_import_new_contributor(self):
        ...
        success_messages, warnings, errors = PersonImporter.process_source_evaluation('contributor', self.evaluation1, test_run=True, source_evaluation=self.evaluation2)
        ...
        success_messages, warnings, errors = PersonImporter.process_source_evaluation('contributor', self.evaluation1, test_run=False, source_evaluation=self.evaluation2)
    ...
    def test_import_existing_participant(self):
        success_messages, warnings, errors = PersonImporter.process_source_evaluation('participant', self.evaluation1, test_run=True, source_evaluation=self.evaluation1)
        ...
        success_messages, warnings, errors = PersonImporter.process_source_evaluation('participant', self.evaluation1, test_run=False, source_evaluation=self.evaluation1)
    ...
    def test_import_new_participant(self):
        success_messages, warnings, errors = PersonImporter.process_source_evaluation('participant', self.evaluation1, test_run=True, source_evaluation=self.evaluation2)
        ...
        success_messages, warnings, errors = PersonImporter.process_source_evaluation('participant', self.evaluation1, test_run=False, source_evaluation=self.evaluation2)
