...
class MergeUsersTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.contribution1 = mommy.make(Contribution, contributors=[cls.main_user], course=cls.course1)
        cls.contribution2 = mommy.make(Contribution, contributors=[cls.other_user], course=cls.course1)  # this should make the merge fail
        cls.contribution3 = mommy.make(Contribution, contributors=[cls.other_user], course=cls.course2)
