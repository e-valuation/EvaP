...
class TestImportEvents(TestCase):
    ...
    def test_exam_type_existing(self):
        ...
        assert exam_evaluation.name_de == exam_type.name_de
        assert exam_evaluation.name_en == exam_type.name_en
    ...
    def test_exam_type_different_name(self):
        ...
        assert exam_evaluation.exam_type.name_de == "Präsentation"
        assert exam_evaluation.exam_type.name_en == "Präsentation"
        assert exam_evaluation.name_de == exam_evaluation.exam_type.name_de
        assert exam_evaluation.name_en == exam_evaluation.exam_type.name_de
