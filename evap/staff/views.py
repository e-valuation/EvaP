...
def semester_evaluation_operation(request, semester_id):
    ...
    if request.method == 'POST':
        ...
        if request.POST.get('send_email') == 'on':
            email_template = EmailTemplate(subject=request.POST['email_subject'], plain_content=request.POST['email_plain'], html_content=request.POST['email_html'])
        if request.POST.get('send_email_contributor') == 'on':
            email_template_contributor = EmailTemplate(subject=request.POST['email_subject_contributor'], plain_content=request.POST['email_plain_contributor'], html_content=request.POST['email_html_contributor'])
        if request.POST.get('send_email_participant') == 'on':
            email_template_participant = EmailTemplate(subject=request.POST['email_subject_participant'], plain_content=request.POST['email_plain_participant'], html_content=request.POST['email_html_participant'])
