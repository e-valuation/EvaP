...
class EvaluationLink(models.Model):
    evaluation = models.ForeignKey(
        Evaluation, models.CASCADE, verbose_name=_("evaluation"), related_name="cms_evaluation_links"
    )
...
class CourseLink(models.Model):
    course = models.ForeignKey(Course, models.CASCADE, verbose_name=_("course"), related_name="cms_course_links")
