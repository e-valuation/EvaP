...
EXAMPLE_DATA_SPECIAL_CASES: ImportDict = {
    "students": [
        ...
        {"gguid": "0x3", "email": "3@example.com", "name": "3", "christianname": "w_3", "callingname": "3"},
    ...
    "events": [
        ...
        },
        {
            ...
            "appointments": [{"begin": "01.01.2025 01:01:01", "end": "31.12.2025 12:31:00"}],
            "lecturers": [{"gguid": "0x3"}],
            "students": [{"gguid": "0x1"}, {"gguid": "0x2"}, {"gguid": "0x3"}],
        ...
        },
        {
            ...
            "students": [{"gguid": "0x1"}, {"gguid": "0x3"}, {"gguid": "0x7"}],
            "appointments": [{"begin": "29.07.2024 10:15:00", "end": "29.07.2024 11:45:00"}],
            "language": "Deutsch",
        },
    ],
...
class TestImportEvents(TestCase):
    ...
    def test_import_courses(self):
        ...
        self.assertEqual(
            [cms_course_link.cms_id for cms_course_link in course.cms_course_links.all()],
            [EXAMPLE_DATA["events"][0]["gguid"]],
        )
        ...
        self.assertTrue(exam_evaluation.is_rewarded)
    ...
    def test_import_courses_special_cases(self):
        ...
        evaluation_without_exam = Evaluation.objects.get(cms_evaluation_links__cms_id="0x8")
        ...
        evaluation_everything = Evaluation.objects.get(cms_evaluation_links__cms_id="0x44")
        ...
        evaluation_life = Evaluation.objects.get(cms_evaluation_links__cms_id="0x42")
        self.assertEqual(evaluation_life.name_de, "Klausur")
        self.assertEqual(evaluation_life.name_en, "Exam")
        evaluation_universe = Evaluation.objects.get(cms_evaluation_links__cms_id="0x43")
        ...
        evaluation_early = Evaluation.objects.get(cms_evaluation_links__cms_id="0x51")
        ...
        evaluation_late_lecture = Evaluation.objects.get(cms_evaluation_links__cms_id="0x50")
    ...
    def test_import_ignore_non_responsible_users(self):
        with override_settings(NON_RESPONSIBLE_USERS=["4@example.com", "ignored.lecturer2@example.com"]):
            self._import(EXAMPLE_DATA_SPECIAL_CASES)
            evaluation = Evaluation.objects.get(cms_evaluation_links__cms_id="0x9")
    ...
    def test_import_skipped_because_of_course_type_skipped(self):
        ...
        self.assertFalse(Evaluation.objects.filter(cms_evaluation_links__cms_id="0x5").exists())
        self.assertFalse(Evaluation.objects.filter(cms_evaluation_links__cms_id="0x6").exists())
    ...
    def test_exam_type_existing(self):
        ...
        exam_evaluation = Evaluation.objects.get(cms_evaluation_links__cms_id=data["events"][1]["gguid"])
    ...
    def test_exam_missing_language(self):
        ...
        evaluation = Evaluation.objects.get(cms_evaluation_links__cms_id=EXAMPLE_DATA["events"][1]["gguid"])
        self.assertEqual(evaluation.main_language, "de")

    def test_import_merged_evaluations(self):
        self._import(EXAMPLE_DATA_SPECIAL_CASES)
        main_evaluation = Evaluation.objects.get(cms_evaluation_links__cms_id="0x10")
        other_evaluation = Evaluation.objects.get(cms_evaluation_links__cms_id="0x44")

        cms_evaluation_link = other_evaluation.cms_evaluation_links.first()
        cms_evaluation_link.evaluation = main_evaluation
        cms_evaluation_link.save()
        baker.make(IgnoredEvaluation, cms_id=cms_evaluation_link.cms_id, course=other_evaluation.course)
        main_evaluation.participants.add(*other_evaluation.participants.all())
        other_evaluation.delete()
    ...
    def test_import_inactive_link(self):
        self._import(EXAMPLE_DATA_SPECIAL_CASES)
        evaluation = Evaluation.objects.get(cms_evaluation_links__cms_id="0x51")
        self.assertEqual(evaluation.main_language, "de")
        ...
        self._import(EXAMPLE_DATA_SPECIAL_CASES)
        cms_evaluation_link = EvaluationLink.objects.get(cms_id="0x51")
        evaluation = cms_evaluation_link.evaluation
        self.assertEqual(evaluation.main_language, "de")

        cms_evaluation_link.is_active = False
        cms_evaluation_link.save()
        evaluation.main_language = "en"
        evaluation.save()
        ...
        self._import(EXAMPLE_DATA_SPECIAL_CASES)
        evaluation = Evaluation.objects.get(cms_evaluation_links__cms_id="0x51")
        self.assertEqual(evaluation.main_language, "en")
