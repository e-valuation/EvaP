...
class VoteTests(TestCase):
    ...
    def test_user_cannot_vote_for_themselves(self):
        ...
        for contributor, _ in response.context['contributor_questionnaires']:
        ...
        response = get_vote_page()
        self.assertTrue(any(contributor == tutor_user for contributor, _ in response.context['contributor_questionnaires']),
