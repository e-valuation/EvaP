...
class VoteTests(TestCase):
    ...
    def test_user_cannot_vote_for_themselves(self):
        ...
        for contributor in response.context['contributor_questionnaires']:
            self.assertNotEquals(contributor.user, tutor_user,
        ...
        response = get_vote_page()
        self.assertTrue(any(contributor.user == tutor_user for contributor in response.context['contributor_questionnaires']),
