...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const initializeOnFirstInteraction = (): void => {
        if (!picker) {
            createPicker();
        }
        picker?.show();
    ...
    inputElement.addEventListener("focus", initializeOnFirstInteraction);
    inputElement.addEventListener("click", initializeOnFirstInteraction);
    toggleElement.addEventListener("click", initializeOnFirstInteraction);
});
